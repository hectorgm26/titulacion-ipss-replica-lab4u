...
3. **Notificaciones** → Activa el toggle para suscribirte al topic de Firebase Messaging
   - Al entrar a la pantalla, se debe activar el toggle (en ciertos modelos, se debe activar, luego desactivar, y después volver a activar), y luego aparecerá un mensaje de que es necesario ir a los ajustes del sistema.
